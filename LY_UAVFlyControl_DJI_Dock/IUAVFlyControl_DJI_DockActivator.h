#ifndef IUAVFLYCONTROL_DJI_DOCKACTIVATOR_H
#define IUAVFLYCONTROL_DJI_DOCKACTIVATOR_H
...
class IUAVFlyControl_DJI_DockActivator
...
{
public:
    IUAVFlyControl_DJI_DockActivator();
    virtual ~IUAVFlyControl_DJI_DockActivator();

    static IUAVFlyControl_DJI_DockActivator &Get();
