#ifndef LY_AGRIDATAANALYSISPREDICTINTERFACE_H_
#define LY_AGRIDATAANALYSISPREDICTINTERFACE_H_
 
#include <IInterface.h>

class LY_AgriDataAnalysisPredictInterface : public IInterface
{
public:

	static LY_AgriDataAnalysisPredictInterface& Get();
...
#endif  // LY_AgriDataAnalysisPredictInterface_H