#ifndef IAGRIDATAANALYSISPREDICTACTIVATOR_H_
#define IAGRIDATAANALYSISPREDICTACTIVATOR_H_
...
class IAgriDataAnalysisPredictActivator
	: public qnzkna::framework::IBundleActivator

	, public qnzkna::framework::IServiceInterfaceTracker
{
public:
	IAgriDataAnalysisPredictActivator();
	virtual ~IAgriDataAnalysisPredictActivator();

	static IAgriDataAnalysisPredictActivator &Get();
...
#define	ZoneManageService()				IAgriDataAnalysisPredictActivator::Get().getPIZoneManageService()
#define	AgriFarmManagerService()		IAgriDataAnalysisPredictActivator::Get().getPIAgriFarmManagerService()

#endif  // IAgriDataAnalysisPredictActivator_H