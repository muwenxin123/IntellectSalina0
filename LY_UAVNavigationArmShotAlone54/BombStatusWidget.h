...
using BomBCallBackFunction = void(*)(BombStatusWidget *, IUAVNavigationArmShotAlone54Dialog *);
...
public:
    ...
    void initBombData(const BombData &bombData, IUAVNavigationArmShotAlone54Dialog *pIUAVNavigationArmShotAlone54Dialog, BomBCallBackFunction bomBCallBackFunction);
...
private:
    ...
    IUAVNavigationArmShotAlone54Dialog *m_IUAVNavigationArmShotAlone54Dialog;
