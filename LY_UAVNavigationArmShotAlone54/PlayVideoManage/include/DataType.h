...
#define _OSD_MILISECOND        (_OSD_BASE+11)
#define _OSD_APM            (_OSD_BASE+14)

#define _OSD_BASE_EX        0x90000
#define    _OSD_YEAR4_EX        (_OSD_BASE_EX+0)
#define _OSD_YEAR2_EX        (_OSD_BASE_EX+1)
#define _OSD_MONTH3_EX        (_OSD_BASE_EX+2)
#define _OSD_MONTH2_EX        (_OSD_BASE_EX+3)
#define _OSD_DAY_EX            (_OSD_BASE_EX+4)
#define _OSD_WEEK3_EX        (_OSD_BASE_EX+5)
#define    _OSD_CWEEK1_EX        (_OSD_BASE_EX+6)
#define    _OSD_HOUR24_EX        (_OSD_BASE_EX+7)
#define    _OSD_HOUR12_EX        (_OSD_BASE_EX+8)
#define    _OSD_MINUTE_EX        (_OSD_BASE_EX+9)
#define _OSD_SECOND_EX        (_OSD_BASE_EX+10)
#define _OSD_MILISECOND_EX    (_OSD_BASE_EX+11)
#define _OSD_APM_EX            (_OSD_BASE_EX+14)
