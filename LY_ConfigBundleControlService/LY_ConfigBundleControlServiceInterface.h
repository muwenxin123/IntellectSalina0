#ifndef LY_CONFIGBUNDLECONTROLSERVICEINTERFACE_H
#define LY_CONFIGBUNDLECONTROLSERVICEINTERFACE_H

#include <IInterface.h>

class LY_ConfigBundleControlServiceInterface : public IInterface
{
public:

    static LY_ConfigBundleControlServiceInterface &Get();
