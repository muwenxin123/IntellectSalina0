#ifndef _LY_AgriFertilizerPrescription_Interface_H
#define _LY_AgriFertilizerPrescription_Interface_H

#include <IInterface.h>

class LY_AgriFertilizerPrescriptionInterface : public IInterface
{
public:
    ...
    static LY_AgriFertilizerPrescriptionInterface &Get();
...
#endif // _LY_AgriFertilizerPrescriptionPlough_Interface_H
