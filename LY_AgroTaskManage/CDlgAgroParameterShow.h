#ifndef CDLGAGROPARAMETERSHOW_H
#define CDLGAGROPARAMETERSHOW_H
...
namespace Ui {
class CDlgAgroParameterShow;
}

class CDlgAgroParameterShow : public LyDialog
{
    Q_OBJECT

public:
    explicit CDlgAgroParameterShow(QWidget *parent = nullptr);
    ~CDlgAgroParameterShow();
	...
	void InitSprayPrescriptionCombobox();
