                                        ...
                                        )
{
    ...
    LY_UAVFlyControl_MavlinkInterface::Get().SendMsgToAll(IInterface::MSG_Command, QNZKNA_DATAMANAGE_SYSTEMINFO_SYSTEMINTERNALINTERFACE_CONTROL_ID, lParam);
}
#endif

UAVPushButton::UAVPushButton(const unsigned long long weaponId, const unsigned long long int vehicleID, const QObject* vehicle,
                             const QString& strComponentName, const QString& strComponentID,
                             const QString& strProtocolType, const XYWeaponIDSetting& xyWeaponIDSetting,
                             QWidget *parent)
    ...
    , m_XYWeaponIDSetting(xyWeaponIDSetting)
{
...
unsigned long long UAVPushButton::getWeaponId() const
{
    return m_weaponId;
}

unsigned long long UAVPushButton::getVehicleID() const
{
    return m_vehicleID;
}
...
const XYWeaponIDSetting& UAVPushButton::getXYWeaponIDSetting() const
{
    return m_XYWeaponIDSetting;
}
