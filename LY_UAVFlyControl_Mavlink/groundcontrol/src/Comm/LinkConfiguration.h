...
// lysd //         TypeSerial,     ///< Serial Link
// lysd // #endif
// lysd //         TypeUdp,        ///< UDP Link
// lysd //         TypeTcp,        ///< TCP Link
// lysd // #ifdef QGC_ENABLE_BLUETOOTH
// lysd //         TypeBluetooth,  ///< Bluetooth Link
// lysd // #endif
// lysd // #ifdef QT_DEBUG
// lysd //         TypeMock,       ///< Mock Link for Unitesting
// lysd // #endif
// lysd //         TypeLogReplay,
// lysd //         TypeLast        // Last type value (type >= TypeLast == invalid)
        TypeLocal        // TypeLocal type value
    };
    Q_ENUM(LinkType)
