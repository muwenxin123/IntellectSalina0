#ifndef HEALTHANDARMINGCHECKREPORT_H
#define HEALTHANDARMINGCHECKREPORT_H
...
private:
    ...
    QList<HealthAndArmingCheckProblem*> _problemsForCurrentMode; ///< list of HealthAndArmingCheckProblem*

};



#endif // HEALTHANDARMINGCHECKREPORT_H
