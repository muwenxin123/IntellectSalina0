...
class QDomDocument;
// lysd // class PlanViewSettings;

Q_DECLARE_LOGGING_CATEGORY(MissionControllerLog)

typedef QPair<VisualMissionItem*,VisualMissionItem*> VisualItemPair;
// lysd // typedef QHash<VisualItemPair, FlightPathSegment*> FlightPathSegmentHashTable;
...
public:
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*  visualItems                     READ visualItems                    NOTIFY visualItemsChanged)
    // lysd // Q_PROPERTY(QmlObjectListModel*  simpleFlightPathSegments        READ simpleFlightPathSegments       CONSTANT)                               ///< Used by Plan view only for interactive editing
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*  directionArrows                 READ directionArrows                CONSTANT)
    // lysd // Q_PROPERTY(QmlObjectListModel*  incompleteComplexItemLines      READ incompleteComplexItemLines     CONSTANT)                               ///< Segments which are not yet completed.
    // lysd // Q_PROPERTY(QStringList          complexMissionItemNames         READ complexMissionItemNames        NOTIFY complexMissionItemNamesChanged)
    ...
    // lysd // Q_PROPERTY(FlightPathSegment*   splitSegment                    MEMBER _splitSegment                NOTIFY splitSegmentChanged)             ///< Segment which show show + split ui element
    ...
    // lysd // Q_PROPERTY(QString              surveyComplexItemName           READ surveyComplexItemName          CONSTANT)
    // lysd // Q_PROPERTY(QString              corridorScanComplexItemName     READ corridorScanComplexItemName    CONSTANT)
    // lysd // Q_PROPERTY(QString              structureScanComplexItemName    READ structureScanComplexItemName   CONSTANT)
    ...
    ///     @param makeCurrentItem: true: Make this item the current item
    /// @return Newly created item
    // lysd // Q_INVOKABLE VisualMissionItem*  insertROIMissionItem(QGeoCoordinate coordinate, int visualItemIndex, bool makeCurrentItem = false);

    /// Add a new Cancel ROI mission item to the list
    ///     @param visualItemIndex: index to insert at, -1 for end of list
    ///     @param makeCurrentItem: true: Make this item the current item
    /// @return Newly created item
    // lysd // Q_INVOKABLE VisualMissionItem*  insertCancelROIMissionItem(int visualItemIndex, bool makeCurrentItem = false);
    ...
    static void sendItemsToVehicle(Vehicle* vehicle, QList<VisualMissionItem*>* visualMissionItems);
    ...
    QList<VisualMissionItem*>* visualItems                 (void) { return _visualItems; }
    // lysd // QmlObjectListModel* simpleFlightPathSegments    (void) { return &_simpleFlightPathSegments; }
    // lysd // QmlObjectListModel* directionArrows             (void) { return &_directionArrows; }
    // lysd // QmlObjectListModel* incompleteComplexItemLines  (void) { return &_incompleteComplexItemLines; }
    QVariantList        waypointPath                (void) { return _waypointPath; }
    // lysd // QStringList         complexMissionItemNames     (void) const;
    ...
    // lysd // QString             surveyComplexItemName       (void) const;
    // lysd // QString             corridorScanComplexItemName (void) const;
    // lysd // QString             structureScanComplexItemName(void) const;
...
signals:
    ...
    // lysd // void _recalcFlightPathSegmentsSignal    (void);
...
private slots:
    ...
    // lysd // void _recalcFlightPathSegments              (void);
    ...
    // lysd // void _takeoffItemNotRequiredChanged         (void);
...
private:
    ...
    MissionSettingsItem*    _addMissionSettings                 (QList<VisualMissionItem*>* visualItems);
    void                    _centerHomePositionOnMissionItems   (QList<VisualMissionItem*>* visualItems);
    bool                    _loadJsonMissionFile                (const QByteArray& bytes, QList<VisualMissionItem*>* visualItems, QString& errorString);
    bool                    _loadJsonMissionFileV1              (const QJsonObject& json, QList<VisualMissionItem*>* visualItems, QString& errorString);
    bool                    _loadJsonMissionFileV2              (const QJsonObject& json, QList<VisualMissionItem*>* visualItems, QString& errorString);
    bool                    _loadTextMissionFile                (QTextStream& stream, QList<VisualMissionItem*>* visualItems, QString& errorString);
    int                     _nextSequenceNumber                 (void);
    void                    _scanForAdditionalSettings          (QList<VisualMissionItem*>* visualItems, PlanMasterController* masterController);
    ...
    bool                    _loadItemsFromJson                  (const QJsonObject& json, QList<VisualMissionItem*>* visualItems, QString& errorString);
    void                    _initLoadedVisualItems              (QList<VisualMissionItem*>* loadedVisualItems);
    // lysd // FlightPathSegment*      _addFlightPathSegment               (FlightPathSegmentHashTable& prevItemPairHashTable, VisualItemPair& pair, bool mavlinkTerrainFrame);
    ...
    // lysd // FlightPathSegment*      _createFlightPathSegmentWorker      (VisualItemPair& pair, bool mavlinkTerrainFrame);
    ...
    static bool             _convertToMissionItems              (QList<VisualMissionItem*>* visualMissionItems, QList<MissionItem*>& rgMissionItems, QObject* missionItemParent);
...
private:
    ...
    QList<VisualMissionItem*>*  _visualItems =                  nullptr;
    MissionSettingsItem*        _settingsItem =                 nullptr;
    // lysd // PlanViewSettings*           _planViewSettings =             nullptr;
    // lysd // QmlObjectListModel          _simpleFlightPathSegments;
    QVariantList                _waypointPath;
    // lysd // QmlObjectListModel          _directionArrows;
    // lysd // QmlObjectListModel          _incompleteComplexItemLines;
    // lysd // FlightPathSegmentHashTable  _flightPathSegmentHashTable;
    ...
    // lysd // FlightPathSegment*          _splitSegment =                 nullptr;
