...
// lysd // class TerrainAtCoordinateQuery;
...
public:
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*      childItems          READ childItems                                                         CONSTANT)
    ...
    QList<VisualMissionItem*>* childItems(void) { return &_childItems; }
    ...
    // lysd // FlightPathSegment* simpleFlightPathSegment(void) { return _simpleFlightPathSegment; }
    // lysd // void setSimpleFlighPathSegment  (FlightPathSegment* segment) { _simpleFlightPathSegment = segment; }
    // lysd // void clearSimpleFlighPathSegment(void) { _simpleFlightPathSegment = nullptr; }
...
protected:
    ...
    // lysd // FlightPathSegment *     _simpleFlightPathSegment    = nullptr;  ///< The simple item flight segment (if any) which starts with this visual item.
    VisualMissionItem*      _parentItem                 = nullptr;
    QGCGeoBoundingCube      _boundingCube;                          ///< The bounding "cube" of this element.

    /// This is used to reference any subsequent mission items which do not specify a coordinate.
    // lysd // QmlObjectListModel  _childItems;
    QList<VisualMissionItem*>  _childItems;
...
private:
    ...
    // lysd // TerrainAtCoordinateQuery*   _currentTerrainAtCoordinateQuery = nullptr;
