...
public:
    ...
    QList<QGCQGeoCoordinate*>* qmlPathModel(void) { return &_polygonModel; }
    QList<QGCQGeoCoordinate*>& pathModel   (void) { return _polygonModel; }
...
private:
    ...
    QList<QGCQGeoCoordinate*>  _polygonModel;
    bool                _dirty =                false;
