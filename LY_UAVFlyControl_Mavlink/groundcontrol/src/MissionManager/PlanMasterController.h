#ifndef PLANMASTERCONTROLLER_H
#define PLANMASTERCONTROLLER_H

#include <QObject>

#include "MissionController.h"
// lysd // #include "GeoFenceController.h"
// lysd // #include "RallyPointController.h"
#include "Vehicle.h"
#include "MultiVehicleManager.h"
#include "QGCLoggingCategory.h"
// lysd // #include "QmlObjectListModel.h"
...
public:
    ...
    // lysd // PlanMasterController(MAV_AUTOPILOT firmwareType, MAV_TYPE vehicleType, QObject* parent = nullptr);
#endif
    ...
    // lysd // Q_PROPERTY(GeoFenceController*      geoFenceController      READ geoFenceController                     CONSTANT)
    // lysd // Q_PROPERTY(RallyPointController*    rallyPointController    READ rallyPointController                   CONSTANT)
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*      planCreators            MEMBER _planCreators                        NOTIFY planCreatorsChanged)
    ...
    // lysd // GeoFenceController*     geoFenceController(void)    { return &_geoFenceController; }
    // lysd // RallyPointController*   rallyPointController(void)  { return &_rallyPointController; }
...
signals:
    ...
    // lysd // void planCreatorsChanged                (QmlObjectListModel* planCreators);
...
private:
    ...
    // lysd // GeoFenceController      _geoFenceController;
    // lysd // RallyPointController    _rallyPointController;
    ...
    // lysd // QmlObjectListModel*     _planCreators =             nullptr;
};

#endif // PLANMASTERCONTROLLER_H
