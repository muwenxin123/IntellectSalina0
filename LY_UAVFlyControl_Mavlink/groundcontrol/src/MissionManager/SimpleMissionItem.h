...
public:
    ...
    // lysd // Q_PROPERTY(QObject*         cameraSection           READ cameraSection                                      NOTIFY cameraSectionChanged)

    // These properties are used to display the editing ui
    // lysd // Q_PROPERTY(QmlObjectListModel*  comboboxFacts   READ comboboxFacts  CONSTANT)
    // lysd // Q_PROPERTY(QmlObjectListModel*  textFieldFacts  READ textFieldFacts CONSTANT)
    // lysd // Q_PROPERTY(QmlObjectListModel*  nanFacts        READ nanFacts       CONSTANT)


    static QList<EnumInfo_s> MavFrameInfoList();
    ...
    bool scanForSections(QList<VisualMissionItem *>* visualItems, int scanIndex, PlanMasterController* masterController);
    ...
    // lysd // CameraSection*  cameraSection       (void) { return _cameraSection; }
    SpeedSection*   speedSection        (void) { return _speedSection; }

    QList<Fact*>* textFieldFacts  (void) { return &_textFieldFacts; }
    QList<Fact*>* nanFacts        (void) { return &_nanFacts; }
    QList<Fact*>* comboboxFacts   (void) { return &_comboboxFacts; }
    ...
    static FactMetaData *defaultParamMetaData();
...
private:
    ...
    // lysd // CameraSection*  _cameraSection =             nullptr;
    ...
    QList<Fact*>  _textFieldFacts;
    QList<Fact*>  _nanFacts;
    QList<Fact*>  _comboboxFacts;

    // lysd // static FactMetaData*    _altitudeMetaData;
    // lysd // static FactMetaData*    _commandMetaData;
    // lysd // static FactMetaData*    _defaultParamMetaData;
    // lysd // static FactMetaData*    _frameMetaData;
    // lysd // static FactMetaData*    _latitudeMetaData;
    // lysd // static FactMetaData*    _longitudeMetaData;
