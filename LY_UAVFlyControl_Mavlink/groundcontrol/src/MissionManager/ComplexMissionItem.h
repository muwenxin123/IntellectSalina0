...
public:
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*  flightPathSegments  READ flightPathSegments     CONSTANT)
    Q_PROPERTY(bool                 terrainCollision    READ terrainCollision       NOTIFY terrainCollisionChanged)

    // lysd // QmlObjectListModel* flightPathSegments  (void) { return &_flightPathSegments; }
...
protected:
    ...
    // lysd // void        _appendFlightPathSegment(FlightPathSegment::SegmentType segmentType, const QGeoCoordinate& coord1, double coord1AMSLAlt, const QGeoCoordinate& coord2, double coord2AMSLAlt);

    bool                _isIncomplete =                 true;
    int                 _cTerrainCollisionSegments =    0;
    // lysd // QmlObjectListModel  _flightPathSegments;                // Contains FlightPathSegment items

    QMap<QString, FactMetaData*> _metaDataMap;

    static const char* _presetSettingsKey;

    // lysd // QGCToolbox* _toolbox;
    // lysd // SettingsManager* _settingsManager;

private:
};


#endif // COMPLEXMISSIONITEM_H
