...
public:
    ...
    explicit MissionItem(int             sequenceNumber,
                MAV_CMD         command,
                MAV_FRAME       frame,
                double          param1,
                double          param2,
    ...
    explicit MissionItem(const MissionItem& other, QObject* parent = nullptr);
...
private:
    ...
    friend class UAVFlyManage_MavlinkMissionManagerDialog;
#ifdef UNITTEST_BUILD
