#ifndef VTOLLANDINGCOMPLEXITEM_H
#define VTOLLANDINGCOMPLEXITEM_H
...
public:
    ...
    static bool scanForItem(QList<VisualMissionItem*>* visualItems, bool flyView, PlanMasterController* masterController);
...
#endif // VTOLLANDINGCOMPLEXITEM_H
