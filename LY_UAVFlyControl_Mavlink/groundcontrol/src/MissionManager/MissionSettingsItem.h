#ifndef MISSIONSETTINGSITEM_H
#define MISSIONSETTINGSITEM_H
...
public:
    ...
    // lysd // Q_PROPERTY(QObject* cameraSection               READ cameraSection                                          CONSTANT)
    ...
    bool scanForMissionSettings(QList<VisualMissionItem *> *visualItems, int scanIndex);
...
private:
    ...
    // lysd // CameraSection   _cameraSection;
