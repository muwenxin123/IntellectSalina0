#ifndef LANDINGCOMPLEXITEM_H
#define LANDINGCOMPLEXITEM_H
...
protected:
    ...
    static bool _scanForItem(QList<VisualMissionItem*>* visualItems, bool flyView, PlanMasterController* masterController, IsLandItemFunc isLandItemFunc, CreateItemFunc createItemFunc);
