...
{
    // lysd // QGeoCoordinate coord = coordinate();
    // lysd // if (specifiesCoordinate() && coord.isValid() && (qIsNaN(_terrainAltitude) || !QGC::fuzzyCompare(_lastLatTerrainQuery, coord.latitude()) || !QGC::fuzzyCompare(_lastLonTerrainQuery, coord.longitude()))) {
    // lysd //     _lastLatTerrainQuery = coord.latitude();
    // lysd //     _lastLonTerrainQuery = coord.longitude();
    // lysd //     if (_currentTerrainAtCoordinateQuery) {
    // lysd //         disconnect(_currentTerrainAtCoordinateQuery, &TerrainAtCoordinateQuery::terrainDataReceived, this, &VisualMissionItem::_terrainDataReceived);
    // lysd //         _currentTerrainAtCoordinateQuery = nullptr;
    // lysd //     }
    // lysd //     _currentTerrainAtCoordinateQuery = new TerrainAtCoordinateQuery(true /* autoDelet */);
    // lysd //     connect(_currentTerrainAtCoordinateQuery, &TerrainAtCoordinateQuery::terrainDataReceived, this, &VisualMissionItem::_terrainDataReceived);
    // lysd //     QList<QGeoCoordinate> rgCoord;
    // lysd //     rgCoord.append(coordinate());
    // lysd //     _currentTerrainAtCoordinateQuery->requestData(rgCoord);
    // lysd // }
}
