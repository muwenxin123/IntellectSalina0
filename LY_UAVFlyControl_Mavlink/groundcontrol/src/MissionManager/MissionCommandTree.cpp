...
void MissionCommandTree::setToolbox()
{
    ...
    if (_unitTest) {
        ...
        for (const QGCMAVLink::FirmwareClass_t firmwareClass: QGCApplication::firmwarePluginManager()->supportedFirmwareClasses()) {
            FirmwarePlugin* plugin = QGCApplication::firmwarePluginManager()->firmwarePluginForAutopilot(QGCMAVLink::firmwareClassToAutopilot(firmwareClass), MAV_TYPE_QUADROTOR);
...
QVariantList MissionCommandTree::getCommandsForCategory(Vehicle* vehicle, const QString& category, bool showFlyThroughCommands)
{
    ...
    FirmwarePlugin* firmwarePlugin = QGCApplication::firmwarePluginManager()->firmwarePluginForAutopilot(QGCMAVLink::firmwareClassToAutopilot(firmwareClass), QGCMAVLink::vehicleClassToMavType(vehicleClass));
