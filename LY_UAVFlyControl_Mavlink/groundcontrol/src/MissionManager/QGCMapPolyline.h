#ifndef QGCMAPPOLYLINE_H
#define QGCMAPPOLYLINE_H
...
public:
    ...
    // lysd // Q_PROPERTY(QmlObjectListModel*  pathModel   READ qmlPathModel                           CONSTANT)
    ...
    QList<QGCQGeoCoordinate*>* qmlPathModel(void) { return &_polylineModel; }
    QList<QGCQGeoCoordinate*>& pathModel   (void) { return _polylineModel; }
...
private:
    ...
    QList<QGCQGeoCoordinate*>  _polylineModel;
    bool                _dirty;
    bool                _interactive;
    bool                _resetActive;
