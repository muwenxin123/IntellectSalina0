...
MissionSettingsItem::MissionSettingsItem(PlanMasterController* masterController, bool flyView)
    ...
    // lysd // , _cameraSection                    (masterController)
    , _speedSection                     (masterController)
{
    ...
    // lysd // connect(&_cameraSection,    &CameraSection::itemCountChanged,                       this, &MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
    // lysd // connect(&_speedSection,     &CameraSection::itemCountChanged,                       this, &MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
    connect(this,               &MissionSettingsItem::terrainAltitudeChanged,           this, &MissionSettingsItem::_setHomeAltFromTerrain);
    // lysd // connect(&_cameraSection,    &CameraSection::dirtyChanged,                           this, &MissionSettingsItem::_sectionDirtyChanged);
    connect(&_speedSection,     &SpeedSection::dirtyChanged,                            this, &MissionSettingsItem::_sectionDirtyChanged);
    // lysd // connect(&_cameraSection,    &CameraSection::specifiedGimbalYawChanged,              this, &MissionSettingsItem::specifiedGimbalYawChanged);
    // lysd // connect(&_cameraSection,    &CameraSection::specifiedGimbalPitchChanged,            this, &MissionSettingsItem::specifiedGimbalPitchChanged);
...
int MissionSettingsItem::lastSequenceNumber(void) const
{
    ...
    // lysd // lastSequenceNumber += _cameraSection.itemCount();
...
bool MissionSettingsItem::scanForMissionSettings(QList<VisualMissionItem *>* visualItems, int scanIndex)
{
    ...
    // lysd // foundCameraSection = _cameraSection.scanForSection(visualItems, scanIndex);
...
{
    // lysd // return _cameraSection.specifyGimbal() ? _cameraSection.gimbalYaw()->rawValue().toDouble() : std::numeric_limits<double>::quiet_NaN();
    return std::numeric_limits<double>::quiet_NaN();
}

double MissionSettingsItem::specifiedGimbalPitch(void)
{
    // lysd // return _cameraSection.specifyGimbal() ? _cameraSection.gimbalPitch()->rawValue().toDouble() : std::numeric_limits<double>::quiet_NaN();
    return std::numeric_limits<double>::quiet_NaN();
}
