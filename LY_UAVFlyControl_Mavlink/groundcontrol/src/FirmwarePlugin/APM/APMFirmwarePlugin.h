...
public:
    ...
    void                guidedModeGotoLocationChangeAltitude(Vehicle* vehicle, const QGeoCoordinate& gotoCoord) override;
    ...
    void                adjustOutgoingMavlinkMessageThreadSafe(Vehicle* vehicle, mavlink_message_t* message) override;
...
private slots:
    // lysd // void _artooSocketError(QAbstractSocket::SocketError socketError);

private:
    void _adjustCalibrationMessageSeverity(Vehicle* vehicle, mavlink_message_t* message) const;
    void _setInfoSeverity(Vehicle* vehicle, mavlink_message_t* message) const;
    ...
    void _handleOutgoingParamSetThreadSafe(Vehicle* vehicle, mavlink_message_t* message);
    ...
    static uint8_t          _reencodeMavlinkChannel(Vehicle *vehicle);
