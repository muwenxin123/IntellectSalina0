...
public:
    ...
    /// Command vehicle to move to specified location (altitude is included and relative)
    virtual void guidedModeGotoLocationChangeAltitude(Vehicle* vehicle, const QGeoCoordinate& gotoCoord);
    ...
    ///     @param message[in,out] Mavlink message to adjust if needed.
    virtual void adjustOutgoingMavlinkMessageThreadSafe(Vehicle* vehicle, mavlink_message_t* message);
    ...
    // lysd // virtual Autotune* createAutotune(Vehicle *vehicle);
