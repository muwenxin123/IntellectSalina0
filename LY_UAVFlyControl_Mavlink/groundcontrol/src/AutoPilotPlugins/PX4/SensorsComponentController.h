...
public:
    ...
    // lysd // Q_PROPERTY(QQuickItem* statusLog MEMBER _statusLog)
    // lysd // Q_PROPERTY(QQuickItem* progressBar MEMBER _progressBar)

    // lysd // Q_PROPERTY(QQuickItem* compassButton MEMBER _compassButton)
    // lysd // Q_PROPERTY(QQuickItem* gyroButton MEMBER _gyroButton)
    // lysd // Q_PROPERTY(QQuickItem* accelButton MEMBER _accelButton)
    // lysd // Q_PROPERTY(QQuickItem* airspeedButton MEMBER _airspeedButton)
    // lysd // Q_PROPERTY(QQuickItem* levelButton MEMBER _levelButton)
    // lysd // Q_PROPERTY(QQuickItem* cancelButton MEMBER _cancelButton)
    // lysd // Q_PROPERTY(QQuickItem* setOrientationsButton MEMBER _setOrientationsButton)
    // lysd // Q_PROPERTY(QQuickItem* orientationCalAreaHelpText MEMBER _orientationCalAreaHelpText)
...
private:
    ...
    // lysd // QQuickItem* _statusLog;
    // lysd // QQuickItem* _progressBar;
    // lysd // QQuickItem* _compassButton;
    // lysd // QQuickItem* _gyroButton;
    // lysd // QQuickItem* _accelButton;
    // lysd // QQuickItem* _airspeedButton;
    // lysd // QQuickItem* _levelButton;
    // lysd // QQuickItem* _cancelButton;
    // lysd // QQuickItem* _setOrientationsButton;
    // lysd // QQuickItem* _orientationCalAreaHelpText;
