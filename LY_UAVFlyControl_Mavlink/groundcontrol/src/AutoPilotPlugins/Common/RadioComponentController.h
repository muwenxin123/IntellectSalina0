...
public:
    ...
    // lysd // Q_PROPERTY(QQuickItem* statusText   MEMBER _statusText      NOTIFY statusTextChanged)
    // lysd // Q_PROPERTY(QQuickItem* cancelButton MEMBER _cancelButton    NOTIFY cancelButtonChanged)
    // lysd // Q_PROPERTY(QQuickItem* nextButton   MEMBER _nextButton      NOTIFY nextButtonChanged)
    // lysd // Q_PROPERTY(QQuickItem* skipButton   MEMBER _skipButton      NOTIFY skipButtonChanged)
...
private:
    ...
    // lysd // QQuickItem* _statusText     = nullptr;
    // lysd // QQuickItem* _cancelButton   = nullptr;
    // lysd // QQuickItem* _nextButton     = nullptr;
    // lysd // QQuickItem* _skipButton     = nullptr;
