...
public:
    ...
    // lysd // Q_PROPERTY(QQuickItem* nextButton                       MEMBER _nextButton)
...
private slots:
    ...
    void _mavlinkMessageReceived(LinkInterface* link, unsigned long long int  weaponId, mavlink_message_t message);
