#ifndef LY_AgriySprayPrescriptionServiceINTERFACE_H
#define LY_AgriySprayPrescriptionServiceINTERFACE_H

#include <IInterface.h>

class LY_AgriySprayPrescriptionServiceInterface : public IInterface
{
public:

    static LY_AgriySprayPrescriptionServiceInterface& Get();
