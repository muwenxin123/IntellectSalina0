#ifndef IAGRIMACHINEMANAGERACTIVATOR_H_
#define IAGRIMACHINEMANAGERACTIVATOR_H_
...
class IAgriMachineManagerActivator
	: public qnzkna::framework::IBundleActivator

	, public qnzkna::framework::IServiceInterfaceTracker
{
public:
	IAgriMachineManagerActivator();
	virtual ~IAgriMachineManagerActivator();

	static IAgriMachineManagerActivator &Get();
...
#endif  // IAgriMachineManagerActivator_H