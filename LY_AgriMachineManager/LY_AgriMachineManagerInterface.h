#ifndef LY_AGRIMACHINEMANAGERINTERFACE_H_
#define LY_AGRIMACHINEMANAGERINTERFACE_H_
 
#include <IInterface.h>

class LY_AgriMachineManagerInterface : public IInterface
{
public:

	static LY_AgriMachineManagerInterface& Get();
...
#endif  // LY_AgriMachineManagerInterface_H