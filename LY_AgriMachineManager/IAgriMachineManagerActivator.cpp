...
IAgriMachineManagerActivator::IAgriMachineManagerActivator()
...
IAgriMachineManagerActivator &IAgriMachineManagerActivator::Get()
{
    static IAgriMachineManagerActivator sIAgriMachineManagerActivator;
    return sIAgriMachineManagerActivator;
}

qnzkna::framework::IRegistry *IAgriMachineManagerActivator::getIRegistryImpl() const
{
    return m_IRegistryImpl;
}

qnzkna::SystemConfig::IConfigProjectControlService *IAgriMachineManagerActivator::getPIConfigProjectControlService() const
{
    return m_pIConfigProjectControlService;
}

qnzkna::WeaponManage::IWeaponManageService *IAgriMachineManagerActivator::getPIWeaponManageService() const
{
    return m_pIWeaponManageService;
}

qnzkna::PositionManage::IPositionManageService *IAgriMachineManagerActivator::getPIPositionManageService() const
{
    return m_pIPositionManageService;
}

qnzkna::UAVRealTimeStateManage::IUAVRealTimeStateManageService *IAgriMachineManagerActivator::getPIUAVRealTimeStateManageService() const
{
    return m_pIUAVRealTimeStateManageService;
}

qnzkna::TextToSpeechManage::ITextToSpeechManageService *IAgriMachineManagerActivator::getPITextToSpeechManageService() const
{
    return m_pITextToSpeechManageService;
}

qnzkna::ZoneManage::IZoneManageService * IAgriMachineManagerActivator::getPIZoneManageService() const
{
	return m_pIZoneManageService;
}

qnzkna::TaskManage::INebulaTaskManageService* IAgriMachineManagerActivator::getPTaskManageService() const
{
	return m_pITaskManageService;
}

void IAgriMachineManagerActivator::start(qnzkna::framework::IRegistry* const context )
{
...
void IAgriMachineManagerActivator::stop(qnzkna::framework::IRegistry *const context)
{
    m_IRegistryImpl = context;
    if (m_IRegistryImpl == nullptr)
    {
...
bool IAgriMachineManagerActivator::addingService(const qnzkna::framework::ServiceReference &service)
{
...
bool IAgriMachineManagerActivator::removedService(const qnzkna::framework::ServiceReference &service)
{
    if (service.getServiceName() == "Ly.IConfigProjectControlService")
    {
...
bool IAgriMachineManagerActivator::dealingMessage(const qnzkna::framework::MessageReference &message)
{
