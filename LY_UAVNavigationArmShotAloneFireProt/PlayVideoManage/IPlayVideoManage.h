...
public:
    CVideoDevice(const std::string& videoComponentID, const std::string& videoDeviceType, const std::string& videoDeviceURL, const std::string& videoDeviceURLInfrared, const std::string& videoDevicePort,
                 const std::string& videoDeviceChannel, const std::string& videoDeviceUserName, const std::string& videoDevicePassWord) {
    ...
    void SetVideoDeviceType(const std::string& videoDeviceType) { m_VideoDeviceType = videoDeviceType; }
    const std::string& GetVideoDeviceType() const { return m_VideoDeviceType; }

    void SetVideoDeviceURL(const std::string& videoDeviceURL) { m_VideoDeviceURL = videoDeviceURL; }
    const std::string& GetVideoDeviceURL() const { return m_VideoDeviceURL; }

    void SetVideoDeviceURLInfrared(const std::string& videoDeviceURLInfrared) { m_VideoDeviceURLInfrared = videoDeviceURLInfrared; }
    const std::string& GetVideoDeviceURLInfrared() const { return m_VideoDeviceURLInfrared; }

    void SetVideoDevicePort(const std::string& videoDevicePort) { m_VideoDevicePort = videoDevicePort; }
    const std::string& GetVideoDevicePort() const { return m_VideoDevicePort; }

    void SetVideoDeviceChannel(const std::string& videoDeviceChannel) { m_VideoDeviceChannel = videoDeviceChannel; }
    const std::string& GetVideoDeviceChannel() const { return m_VideoDeviceChannel; }

    void SetVideoDeviceUserName(const std::string& videoDeviceUserName) { m_VideoDeviceUserName = videoDeviceUserName; }
    const std::string& GetVideoDeviceUserName() const { return m_VideoDeviceUserName; }

    void SetVideoDevicePassWord(const std::string& videoDevicePassWord) { m_VideoDevicePassWord = videoDevicePassWord; }
    const std::string& GetVideoDevicePassWord() const { return m_VideoDevicePassWord; }

    void SetVideoComponentID(const std::string &VideoComponentID) { m_VideoComponentID = VideoComponentID; }
    const std::string& GetVideoComponentID() const { return m_VideoComponentID; }
...
public:
    ...
    virtual void SetVideoControlDetect(bool enable) { }
    virtual void SetVideoControlButton(bool enable) { }
