...
public:
    ...
    void SetVideoDeviceType54(const bool videoDeviceType54) { m_VideoDeviceType54= videoDeviceType54; }
    bool GetVideoDeviceType54() const { return m_VideoDeviceType54; }

    void SetVideoDeviceInfraredEnable(const bool videoDeviceInfraredEnable) { m_VideoDeviceInfraredEnable= videoDeviceInfraredEnable; }
    bool GetVideoDeviceInfraredEnable() const { return m_VideoDeviceInfraredEnable; }

    void SetVideoWindowMove(const bool videoWindowMove) { m_VideoWindowMove= videoWindowMove; }
    bool GetVideoWindowMove() const { return m_VideoWindowMove; }

    void setVideoDeviceMulticastInterfaceName(const QString &videoDeviceMulticastInterfaceName){ m_VideoDeviceMulticastInterfaceName = videoDeviceMulticastInterfaceName; }
    const QString& GetVideoDeviceMulticastInterfaceName() const{ return m_VideoDeviceMulticastInterfaceName; }

    void SetVideoDeviceCodecName(const QString& videoDeviceCodecName ) { m_VideoDeviceCodecName = videoDeviceCodecName; }
    const QString& GetVideoDeviceCodecName() const { return m_VideoDeviceCodecName; }

    void SetVideoDeviceCodecExtData(const QByteArray& videoDeviceCodecExtData ) { m_VideoDeviceCodecExtData = videoDeviceCodecExtData; }
    const QByteArray& GetVideoDeviceCodecExtData() const { return m_VideoDeviceCodecExtData; }

    void SetVideoDeviceCodecExtDataInfrared(const QByteArray& videoDeviceCodecExtDataInfrared ) { m_VideoDeviceCodecExtDataInfrared = videoDeviceCodecExtDataInfrared; }
    const QByteArray& GetVideoDeviceCodecExtDataInfrared() const { return m_VideoDeviceCodecExtDataInfrared; }

    void SetVideoDeviceCodecParam(const bool videoDeviceCodecParam) { m_VideoDeviceCodecParam = videoDeviceCodecParam; }
    bool GetVideoDeviceCodecParam() const { return m_VideoDeviceCodecParam; }

    void SetVideoDeviceCodecParamInfrared(const bool videoDeviceCodecParamInfrared) { m_VideoDeviceCodecParamInfrared = videoDeviceCodecParamInfrared; }
    bool GetVideoDeviceCodecParamInfrared() const { return m_VideoDeviceCodecParamInfrared; }
...
public:
    ...
    explicit NetworkWorkerThread(const multicast_configure_t& multicast_configure, QObject *parent = nullptr);
...
public:
    RecvVideoStreamThread(const QString& strUrlName, const CVideoDeviceParam& videoDeviceParam, bool urlNameDeviceType54Infrared = false, QObject *parent = nullptr);
...
public:
    ShowVideoStreamThread(PlayVideoManageWidget54 *widget = nullptr, QObject *parent = nullptr);
