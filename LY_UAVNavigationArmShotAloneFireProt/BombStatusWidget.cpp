...
void BombStatusWidget::initBombData(const BombData &bombData, IUAVNavigationArmShotAloneFireProtDialog *pIUAVNavigationArmShotAloneFireProtDialog, BomBCallBackFunction bomBCallBackFunction)
{
    m_IUAVNavigationArmShotAloneFireProtDialog = pIUAVNavigationArmShotAloneFireProtDialog;
...
void BombStatusWidget::mousePressEvent(QMouseEvent *ev)
{
    ...
    if(m_bomBCallBackFunction != nullptr){
        m_bomBCallBackFunction(this, m_IUAVNavigationArmShotAloneFireProtDialog);
    }
