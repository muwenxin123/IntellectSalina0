#ifndef _LY_AGRICULTUREHOMEPAGE_Interface_H
#define _LY_AGRICULTUREHOMEPAGE_Interface_H

#include <IInterface.h>

class LY_AgricultureHomepageInterface : public IInterface
{
public:
    ...
    static LY_AgricultureHomepageInterface &Get();
...
#endif // _LY_AGRICULTUREHOMEPAGE_Interface_H
