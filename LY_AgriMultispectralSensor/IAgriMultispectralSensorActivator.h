#ifndef IAGRIMULTISPECTRALSENSORACTIVATOR_H_
#define IAGRIMULTISPECTRALSENSORACTIVATOR_H_
...
class IAgriMultispectralSensorActivator
	: public qnzkna::framework::IBundleActivator

	, public qnzkna::framework::IServiceInterfaceTracker
{
public:
	IAgriMultispectralSensorActivator();
	virtual ~IAgriMultispectralSensorActivator();

	static IAgriMultispectralSensorActivator &Get();
...
#define	ZoneManageService()				IAgriMultispectralSensorActivator::Get().getPIZoneManageService()
#define	AgriFarmManagerService()		IAgriMultispectralSensorActivator::Get().getPIAgriFarmManagerService()

#endif  // IAgriMultispectralSensorActivator_H