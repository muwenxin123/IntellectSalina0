...
IAgriMultispectralSensorActivator::IAgriMultispectralSensorActivator()
...
IAgriMultispectralSensorActivator &IAgriMultispectralSensorActivator::Get()
{
    static IAgriMultispectralSensorActivator sIAgriMultispectralSensorActivator;
    return sIAgriMultispectralSensorActivator;
}

qnzkna::framework::IRegistry *IAgriMultispectralSensorActivator::getIRegistryImpl() const
{
    return m_IRegistryImpl;
}

qnzkna::SystemConfig::IConfigProjectControlService *IAgriMultispectralSensorActivator::getPIConfigProjectControlService() const
{
    return m_pIConfigProjectControlService;
}

qnzkna::WeaponManage::IWeaponManageService *IAgriMultispectralSensorActivator::getPIWeaponManageService() const
{
    return m_pIWeaponManageService;
}

qnzkna::PositionManage::IPositionManageService *IAgriMultispectralSensorActivator::getPIPositionManageService() const
{
    return m_pIPositionManageService;
}

qnzkna::UAVRealTimeStateManage::IUAVRealTimeStateManageService *IAgriMultispectralSensorActivator::getPIUAVRealTimeStateManageService() const
{
    return m_pIUAVRealTimeStateManageService;
}

qnzkna::TextToSpeechManage::ITextToSpeechManageService *IAgriMultispectralSensorActivator::getPITextToSpeechManageService() const
{
    return m_pITextToSpeechManageService;
}

qnzkna::ZoneManage::IZoneManageService * IAgriMultispectralSensorActivator::getPIZoneManageService() const
{
	return m_pIZoneManageService;
}

qnzkna::TaskManage::INebulaTaskManageService* IAgriMultispectralSensorActivator::getPTaskManageService() const
{
	return m_pITaskManageService;
}

qnzkna::AgriFarmManager::IAgriFarmManagerService* IAgriMultispectralSensorActivator::getPIAgriFarmManagerService() const
{
	return m_pIAgriFarmManagerService;
}

void IAgriMultispectralSensorActivator::start(qnzkna::framework::IRegistry* const context )
{
...
void IAgriMultispectralSensorActivator::stop(qnzkna::framework::IRegistry *const context)
{
    m_IRegistryImpl = context;
    if (m_IRegistryImpl == nullptr)
    {
...
bool IAgriMultispectralSensorActivator::addingService(const qnzkna::framework::ServiceReference &service)
{
...
bool IAgriMultispectralSensorActivator::removedService(const qnzkna::framework::ServiceReference &service)
{
    if (service.getServiceName() == "Ly.IConfigProjectControlService")
    {
...
bool IAgriMultispectralSensorActivator::dealingMessage(const qnzkna::framework::MessageReference &message)
{
