#ifndef LY_SCENARIOSREPLAYInterface_H
#define LY_SCENARIOSREPLAYInterface_H

#include <IInterface.h>

class LY_ScenariosReplayInterface : public IInterface
{
public:
    static LY_ScenariosReplayInterface& Get();
