#ifndef _LY_AMMUNITIONMANAGESERVICE_Interface_H
#define _LY_AMMUNITIONMANAGESERVICE_Interface_H

#include <IInterface.h>

class LY_AmmunitionManageServiceInterface : public IInterface
{
public:

    static LY_AmmunitionManageServiceInterface &Get();
