#ifndef _LY_AgriSprayPrescription_Interface_H
#define _LY_AgriSprayPrescription_Interface_H

#include <IInterface.h>

class LY_AgriSprayPrescriptionInterface : public IInterface
{
public:
    ...
    static LY_AgriSprayPrescriptionInterface &Get();
...
#endif // _LY_AgriSprayPrescriptionPlough_Interface_H
