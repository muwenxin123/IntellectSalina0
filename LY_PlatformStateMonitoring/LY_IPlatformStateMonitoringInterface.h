#ifndef LY_IPLATFORMSTATEMONITORINGINTERFACE_H
#define LY_IPLATFORMSTATEMONITORINGINTERFACE_H

#include <IInterface.h>

class LY_IPlatformStateMonitoringInterface : public IInterface
{
public:

    static LY_IPlatformStateMonitoringInterface& Get();
