...
TEMPLATE = lib
DEFINES += LY_SENSORMANAGESERVICE_LIBRARY

TARGET = LY_SensorManageService
...
SOURCES += \
    LY_SensorManageServiceInterface.cpp \
    LY_SensorManageService.cpp

HEADERS += \
    LY_SensorManageServiceInterface.h \
    LY_SensorManageService_global.h \
    LY_SensorManageService.h
...
include(SensorManage/SensorManage.pri)
