#ifndef IAGRIFARMMANAGERACTIVATOR_H_
#define IAGRIFARMMANAGERACTIVATOR_H_
...
class IAgriFarmManagerActivator
	: public qnzkna::framework::IBundleActivator

	, public qnzkna::framework::IServiceInterfaceTracker
{
public:
	IAgriFarmManagerActivator();
	virtual ~IAgriFarmManagerActivator();

	static IAgriFarmManagerActivator &Get();
...
#define	ZoneManageService() IAgriFarmManagerActivator::Get().getPIZoneManageService()

#endif  // IAgriFarmManagerActivator_H