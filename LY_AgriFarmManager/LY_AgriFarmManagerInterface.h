#ifndef LY_AGRIFARMMANAGERINTERFACE_H_
#define LY_AGRIFARMMANAGERINTERFACE_H_
 
#include <IInterface.h>

class LY_AgriFarmManagerInterface : public IInterface
{
public:

	static LY_AgriFarmManagerInterface& Get();
...
#endif  // LY_AgriFarmManagerInterface_H