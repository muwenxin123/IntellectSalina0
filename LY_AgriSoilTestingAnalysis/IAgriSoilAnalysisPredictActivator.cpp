...
IAgriSoilAnalysisPredictActivator::IAgriSoilAnalysisPredictActivator()
...
IAgriSoilAnalysisPredictActivator &IAgriSoilAnalysisPredictActivator::Get()
{
    static IAgriSoilAnalysisPredictActivator sIAgriDataAnalysisPredictActivator;
    return sIAgriDataAnalysisPredictActivator;
}

qnzkna::framework::IRegistry *IAgriSoilAnalysisPredictActivator::getIRegistryImpl() const
{
    return m_IRegistryImpl;
}

qnzkna::SystemConfig::IConfigProjectControlService *IAgriSoilAnalysisPredictActivator::getPIConfigProjectControlService() const
{
    return m_pIConfigProjectControlService;
}

qnzkna::WeaponManage::IWeaponManageService *IAgriSoilAnalysisPredictActivator::getPIWeaponManageService() const
{
    return m_pIWeaponManageService;
}

qnzkna::PositionManage::IPositionManageService *IAgriSoilAnalysisPredictActivator::getPIPositionManageService() const
{
    return m_pIPositionManageService;
}

qnzkna::UAVRealTimeStateManage::IUAVRealTimeStateManageService *IAgriSoilAnalysisPredictActivator::getPIUAVRealTimeStateManageService() const
{
    return m_pIUAVRealTimeStateManageService;
}

qnzkna::TextToSpeechManage::ITextToSpeechManageService *IAgriSoilAnalysisPredictActivator::getPITextToSpeechManageService() const
{
    return m_pITextToSpeechManageService;
}

qnzkna::ZoneManage::IZoneManageService * IAgriSoilAnalysisPredictActivator::getPIZoneManageService() const
{
	return m_pIZoneManageService;
}

qnzkna::TaskManage::INebulaTaskManageService* IAgriSoilAnalysisPredictActivator::getPTaskManageService() const
{
	return m_pITaskManageService;
}

qnzkna::AgriFarmManager::IAgriFarmManagerService* IAgriSoilAnalysisPredictActivator::getPIAgriFarmManagerService() const
{
	return m_pIAgriFarmManagerService;
}

void IAgriSoilAnalysisPredictActivator::start(qnzkna::framework::IRegistry* const context )
{
...
void IAgriSoilAnalysisPredictActivator::stop(qnzkna::framework::IRegistry *const context)
{
    m_IRegistryImpl = context;
    if (m_IRegistryImpl == nullptr)
    {
...
bool IAgriSoilAnalysisPredictActivator::addingService(const qnzkna::framework::ServiceReference &service)
{
...
bool IAgriSoilAnalysisPredictActivator::removedService(const qnzkna::framework::ServiceReference &service)
{
    if (service.getServiceName() == "Ly.IConfigProjectControlService")
    {
...
bool IAgriSoilAnalysisPredictActivator::dealingMessage(const qnzkna::framework::MessageReference &message)
{
