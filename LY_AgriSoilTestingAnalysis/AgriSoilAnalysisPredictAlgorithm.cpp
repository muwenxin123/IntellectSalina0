...
using namespace AgriSoilAnalysisPredictAlgorithm;

AgriSoilAnalysisPredictAlgorithm::Poi::Poi(double dLon, double dLat, double dAlt /*= 0.0*/)
{
	lon = dLon;
	lat = dLat;
	alt = dAlt;
...
double AgriSoilAnalysisPredictAlgorithm::Poi::distanceTo(const Poi &other) const
{
...
// 主函数
void AgriSoilAnalysisPredictAlgorithm::zoneMinPath(const std::vector<Poi>& points, std::vector<Poi>& path) {
...
void AgriSoilAnalysisPredictAlgorithm::generatePath(std::vector<QPoint> points, std::vector<QPoint> &path)
{
	if (points.empty()) return;
...
bool AgriSoilAnalysisPredictAlgorithm::createGridGeometryMap(const std::vector<QPointF>& boundPoings, const std::vector<double>& lons, const std::vector<double>& lats, double spacing, std::vector<QPoint>& points, std::map<QPoint, Poi, QPointFCompare>& pointMap)
{
...
bool AgriSoilAnalysisPredictAlgorithm::createGridPointDiffuse(const std::vector<QPointF>& boundPoings, const std::vector<double>& lons, const std::vector<double>& lats, const std::vector<double>& values, double spacing, int difCount, std::vector<Poi>& difPoints)
{
