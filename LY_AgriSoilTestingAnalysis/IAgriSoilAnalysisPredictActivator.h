#ifndef IAGRISOILANALYSISPREDICTACTIVATOR_h__
#define IAGRISOILANALYSISPREDICTACTIVATOR_h__
...
class IAgriSoilAnalysisPredictActivator
...
{
public:
	IAgriSoilAnalysisPredictActivator();
	virtual ~IAgriSoilAnalysisPredictActivator();

	static IAgriSoilAnalysisPredictActivator &Get();
...
#define	ZoneManageService()				IAgriSoilAnalysisPredictActivator::Get().getPIZoneManageService()
#define	AgriFarmManagerService()		IAgriSoilAnalysisPredictActivator::Get().getPIAgriFarmManagerService()

#endif // IAGRISOILANALYSISPREDICTACTIVATOR_h__
