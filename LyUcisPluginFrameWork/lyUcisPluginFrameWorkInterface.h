#ifndef LYUCISPLUGINFRAMEWORKINTERFACE_H
#define LYUCISPLUGINFRAMEWORKINTERFACE_H

#include <IInterface.h>

class LyUcisPluginFrameWorkInterface : public IInterface
{
public:
    static LyUcisPluginFrameWorkInterface &Get();
