#ifndef LY_UAVREALTIMESTATEMANAGESERVICEINTERFACE_H
#define LY_UAVREALTIMESTATEMANAGESERVICEINTERFACE_H

#include <IInterface.h>

class LY_UAVRealTimeStateManageServiceInterface : public IInterface
{
public:

    static LY_UAVRealTimeStateManageServiceInterface& Get();
